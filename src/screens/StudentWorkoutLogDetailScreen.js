...
const styles = StyleSheet.create({
  ...
  subtitle: { color: colors.textDim, fontSize: fs(11), marginTop: vs(4), marginBottom: vs(20), textTransform: 'capitalize' },
  summaryRow: { flexDirection: 'row', marginBottom: vs(24), gap: 10 },
  ...
  summaryValue: { color: colors.text, fontSize: fs(14), fontWeight: '800' },
  summaryLabel: { color: colors.textDim, fontSize: fs(9), marginTop: vs(4) },
  sectionTitle: { color: colors.text, fontSize: fs(14), fontWeight: '700', marginBottom: vs(12) },
  empty: { color: colors.textDim, fontSize: fs(12), marginTop: vs(8) },
  exerciseCard: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: 16, marginBottom: vs(12) },
  exerciseName: { color: colors.text, fontSize: fs(13), fontWeight: '700', marginBottom: vs(8) },
  setRow: {
    flexDirection: 'row',
  ...
  setLabel: { color: colors.textDim, fontSize: fs(11) },
  setValue: { color: colors.text, fontSize: fs(11), fontWeight: '600' },
  noticeBoxDanger: {
    flexDirection: 'row',
  ...
  noticeTitleDanger: { color: colors.red, fontSize: fs(12), fontWeight: '700', marginBottom: vs(4) },
  noticeTextDanger: { color: colors.red, fontSize: fs(11) },
  noticeBox: {
    flexDirection: 'row',
    alignItems: 'flex-start',
  ...
  noticeTitle: { color: colors.amber, fontSize: fs(12), fontWeight: '700', marginBottom: vs(4) },
  noticeText: { color: colors.amber, fontSize: fs(11) },
  noteCard: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: 14, marginBottom: vs(10) },
  noteTitle: { color: colors.text, fontSize: fs(12), lineHeight: 20 },
  noteHighlight: { fontWeight: '700', color: colors.accent },
  noteReason: { color: colors.textDim, fontSize: fs(10), marginTop: vs(4), fontStyle: 'italic' },
});
