...
const styles = StyleSheet.create({
  ...
  profileName: { fontWeight: '700', fontSize: fs(17), color: colors.text, marginTop: vs(12) },
  ...
  subtitle: { color: colors.textDim, fontSize: fs(11), marginBottom: vs(12), lineHeight: 18 },
  ...
  fileInfo: { color: colors.accent, fontSize: fs(11), marginBottom: vs(8) },
  uploadButton: {
    backgroundColor: colors.surface,
    borderRadius: radius.sm,
    padding: 14,
  ...
  uploadButtonText: { color: colors.accent, fontWeight: '600', fontSize: fs(12) },
  checkboxRow: { flexDirection: 'row', alignItems: 'center', marginBottom: vs(16) },
  checkbox: {
    width: 22,
    height: 22,
    borderRadius: 5,
  ...
  checkboxMark: { color: '#04170F', fontWeight: 'bold', fontSize: fs(12) },
  checkboxLabel: { color: colors.text, fontSize: fs(12), flex: 1 },
